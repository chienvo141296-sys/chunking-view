...
const TRANSLATIONS = {
  en: {
    ...
    heroBadge: "Chunking only • Personal Learning Journal",
    ...
    footerText: "Chunking only — Built for Personal Growth, Digital Gardening & Life Philosophy.",
  ...
  vi: {
    ...
    heroBadge: "Chunking only • Nhật ký Học tập & Lập trình",
    ...
    footerText: "Chunking only — Được xây dựng cho việc Phát triển Bản thân & Triết lý Sống.",
